...
public class bankOfAmericaTest {
    ...
    static final String ExcelFilePath = System.getProperty("user.dir") + "/resources/testData/Mock_Data.xlsx";
    ...
    void testFrom(double id, String FirstName, String lastName, String gender, String DoB, String SSN, String Phone, String email) throws Exception {
